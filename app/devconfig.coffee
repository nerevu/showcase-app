try
  ...
  SHOWCASE_DASH_DATA_SRC = $PROCESS_ENV_SHOWCASE_DASH_DATA_SRC or 'local'
catch
  NODE_ENV = process.env.NODE_ENV or 'development'
  SHOWCASE_DASH_DATA_SRC = process.env.SHOWCASE_DASH_DATA_SRC or 'local'

debug =
  mobile: false
  production: NODE_ENV is 'production'
  staging: NODE_ENV is 'staging'
  localFile: SHOWCASE_DASH_DATA_SRC is 'local'
  verbose: false
